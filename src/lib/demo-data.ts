...
export const demoSetups: Setup[] = [
  ...
  { slug: "city-after-rain", title: "City after rain", location: "Київ", owner: "Марія К.", vibe: "Стрімінг · Nearfield", description: "Робоче місце, яке після шостої перетворюється на місце для альбомів цілком. Компактно, тихо, без зайвого блиску.", palette: { background: "#dce7e2", wall: "#cbd9d1" }, components: [demoComponents[1], demoComponents[2], demoComponents[5]] },
