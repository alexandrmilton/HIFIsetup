...
export const demoSetups: Setup[] = [
  { slug: "soft-morning", title: "Soft Morning", location: "Львів", country: "UA", owner: "Андрій С.", vibe: "Вініл · 2 канали", description: "Невелика система для ранкових платівок, повільної кави й уважного слухання. Кожен предмет тут залишений лише тому, що додає щось до музики.", palette: { background: "#dce4dc", wall: "#e9ddc6" }, components: [demoComponents[0], demoComponents[4], demoComponents[2]], coverUrl: null, coverThumbUrl: null, coverPath: null, gallery: [], categories: ["Вініл"], categoryIds: [], isPublished: true, moderationStatus: "approved", likeCount: 0, room: emptyRoom, ownerId: null, createdAt: null, updatedAt: null, comments: [] },
  { slug: "city-after-rain", title: "City after rain", location: "Київ", country: "UA", owner: "Марія К.", vibe: "Стрімінг · Nearfield", description: "Робоче місце, яке після шостої перетворюється на місце для альбомів цілком. Компактно, тихо, без зайвого блиску.", palette: { background: "#dce7e2", wall: "#cbd9d1" }, components: [demoComponents[1], demoComponents[2], demoComponents[5]], coverUrl: null, coverThumbUrl: null, coverPath: null, gallery: [], categories: ["Стрімінг", "Мінімалізм"], categoryIds: [], isPublished: true, moderationStatus: "approved", likeCount: 0, room: emptyRoom, ownerId: null, createdAt: null, updatedAt: null, comments: [] },
  { slug: "walnut-and-warmth", title: "Walnut & warmth", location: "Дрогобич", country: "UA", owner: "Юрій Б.", vibe: "Handmade · Вініл", description: "Сетап навколо лампового підсилювача, зібраного місцевим майстром. Трохи дерева, трохи тепла — і багато старого соулу.", palette: { background: "#e6ded1", wall: "#d8b798" }, components: [demoComponents[0], demoComponents[4], demoComponents[5]], coverUrl: null, coverThumbUrl: null, coverPath: null, gallery: [], categories: ["DIY / Handmade", "Вініл"], categoryIds: [], isPublished: true, moderationStatus: "approved", likeCount: 0, room: emptyRoom, ownerId: null, createdAt: null, updatedAt: null, comments: [] },
];
